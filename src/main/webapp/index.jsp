...
<body>
   <header>
    ...
    <div class="navsignin border">
        ...
        <p class="navone">Account & Lists</p>
    </div>
    <div class="navretun border">
        <p><span>Returns</span></p>
        <p class="navone">& Orders</p>
    </div>
   ...
   <div class="hero">
    <div class="msg">
        <p>You are on amazon.com. You can also shop on Amazon Pakistan for millions of products with fast local delivery. <a href="https://www.amazon.com/" target="_blank" class="am">Click here to go to amazon.pk</a></p>
    </div>
   </div>
   <div class="shop">
        <div class="box1 box">
            <div class="boxcontent">
            <h2>Clothes & Wardrobes</h2>
   ...
   <footer>
    <div class="panel1"><a href="#">Back to top</a></div>
    <div class="panel2">
        <ul>
            <p>Get to Know Us</p>
            <a href="#">Careers</a>
